    ...
    <div className=" mb-4 flex w-full flex-col gap-8 items-center">
                    ...
                    <h3 className="  text-sm text-gray-300">
                      ...
                      {person.companysSite ? (
                        <a
                          ...
                          href={person?.companysSite}
                        >
                          at {person.companysSite}
                        </a>
                      ) : null}
                    </h3>
                  </div>
        ...
        <div className=" w-1/2 py-6 px-4 gap-2 rounded-2xl bg-gray-900 flex flex-col items-center">
          {todos.map((todo) => (
            ...
            >
              ...
              <h2 className=" text-white peer-has-checked:line-through decoration-gray-200 peer-has-hover:text-green-400 peer-has-active:text-sky-500 ">
                {todo.title}
              </h2>
            </label>
          ))}
      ...
      <div className=" flex flex-col w-full items-center gap-2">
        ...
        <div className=" group rounded-2xl outline-1 outline-sky-500 py-4 px-2 items-center flex flex-col w-1/2 gap-3 bg-gray-800 ">
          ...
          <h2 className=" cursor-pointer group-hover:text-gray-200 text-sm group-active:text-blue-500 text-gray-400">
      ...
      <div className="  flex flex-col w-full items-center gap-2">
        ...
        >
          ...
          />
          <h2 className="text-red-500 peer:focus:hidden  not-focus:peer-invalid:block hidden ">
            Please provide a valid email address.
          </h2>
        </div>
      </div>
