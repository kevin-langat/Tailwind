  ...
  return (
    <div className='w-full  mb-10 flex flex-col items-center justify-center gap-4 '>
      ...
      <div className=' w-1/2 py-3 bg-gray-700 outline-1 outline-gray-400 rounded-[0.4em] grid grid-cols-2 gap-3 justify-around items-center'>
        <div className=' flex mask-radial-to-905 flex-col items-center gap-0.5 '>
          <h2 className='text-vsm text-gray-300'>mask-add</h2>
          <div className=' mask-add w-30 h-30  p-1.5 bg-gray-300 bg-cover  mask-[url(/Images/scribble.png),url(/Images/abst.jpg)] mask-[position:30%_50%,70%_50%]  bg-[url(/Images/abstract.png)] '></div>
        </div>
        <div className=' flex flex-col items-center gap-0.5 '>
          <h2 className='text-vsm text-gray-300'>mask-subtract</h2>
          <div className=' mask-subtract   w-30 h-30  p-1.5 bg-gray-300 bg-cover  mask-[url(/Images/scribble.png),url(/Images/abstract.jpg)] mask-[position:30%_50%,70%_50%]  bg-[url(/Images/abstract.png)] '></div>
        </div>
        <div className=' flex flex-col items-center gap-0.5 '>
          <h2 className='text-vsm text-gray-300'>mask-add</h2>
          <div className=' mask-add w-30 h-30  p-1.5 bg-gray-300 bg-cover  mask-[url(/Images/scribble.png),url(/Images/abst.jpg)] mask-[position:30%_50%,70%_50%]  bg-[url(/Images/abstract.png)] '></div>
